...
const faqsData: Record<string, {question: string, answer: string}[]> = {
  'General': [
    { question: "What is The jobsync?", answer: "The jobsync is a comprehensive global recruitment platform..." },
    { question: "What is the main goal of The jobsync?", answer: "Our main goal is to be the trusted bridge between ambition and opportunity..." },
    { question: "Is The jobsync free to use?", answer: "Yes, basic job seeking features are free to use..." },
  ],
  'Job Seekers': [
  ...
  'Employers': [
    { question: "How can my company post jobs on The jobsync?", answer: "You can post jobs by navigating to the Job Posting section under Employers and selecting a plan." },
  ...
  return (
    <section id="faq" className="bg-white dark:bg-slate-900 transition-colors duration-300">
      ...
      <div className="bg-slate-900 dark:bg-slate-950 text-white py-16 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-gray-300 font-medium">Everything you need to know about The jobsync</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        >
          Find answers to the most common questions about The jobsync. Can't find what you're looking for? Contact our support team.
        </p>
