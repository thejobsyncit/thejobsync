        ...
        <div className="bg-[#0f172a] py-8 px-6 text-center text-white relative">
          <div className="flex justify-center mb-4 relative z-10">
            <div className="bg-white p-2 rounded-lg shadow-lg inline-block">
              <div className="font-bold text-[#0f172a] text-2xl tracking-tight w-10 h-10 flex items-center justify-center">A</div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" required value={name} onChange={(e) => setName(e.target.value)} className="block w-full pl-10 pr-3 py-3 bg-white text-gray-900 border border-gray-200 rounded-lg text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0f172a]" placeholder="John Doe" />
                  </div>
                </div>
                <div>
            ...
            {isLogin && (
              <div className="flex items-center justify-between text-xs mt-2">
                ...
                <button type="button" onClick={() => setIsForgotModalOpen(true)} className="text-blue-600 hover:underline bg-transparent border-none p-0 cursor-pointer">Forgot password?</button>
              </div>
            )}
