              ...
              <>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" required value={name} onChange={(e) => setName(e.target.value)} className="block w-full pl-10 pr-3 py-3 bg-white text-black border border-gray-200 rounded-lg text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0f172a]" placeholder="John Doe" />
                  </div>
                </div>
                <div>
